        ...
        return (
            <div>
                ...
                <div className="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
                    ...
                    <a className="me-3 py-2 text-dark text-decoration-none" href="#">About</a>
                    <a href="" type="button" className="btn btn-outline-primary me-2">Login</a>
                    <a href="" type="button" className="btn btn-primary">Signup</a>
                    </nav>
                </div>
                </header>
                </div>
